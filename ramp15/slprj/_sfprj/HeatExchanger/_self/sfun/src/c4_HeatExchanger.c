...
static const char * c4_debug_family_names[4] = { "nargin", "nargout", "time",
  "Pref" };
...
static void finalize_c4_HeatExchanger(SFc4_HeatExchangerInstanceStruct
  *chartInstance);
static void sf_c4_HeatExchanger(SFc4_HeatExchangerInstanceStruct *chartInstance);
static void initSimStructsc4_HeatExchanger(SFc4_HeatExchangerInstanceStruct
  *chartInstance);
static void registerMessagesc4_HeatExchanger(SFc4_HeatExchangerInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_HeatExchangerInstanceStruct
  *chartInstance, const mxArray *c4_Pref, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_HeatExchangerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_HeatExchangerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_HeatExchangerInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_HeatExchanger, const char_T
  *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_HeatExchangerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
  ...
  (SFc4_HeatExchangerInstanceStruct *chartInstance)
{
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_HeatExchanger;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_Pref = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    0)), "Pref");
  chartInstance->c4_is_active_c4_HeatExchanger = c4_d_emlrt_marshallIn
...
static void sf_c4_HeatExchanger(SFc4_HeatExchangerInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_time, 2U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_Pref, 3U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2448593058U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2475103563U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(624554365U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1054116652U);
}
...
mxArray *sf_c4_HeatExchanger_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("jC8Lmds3dEns5Z4bICwAjC");
...
static const mxArray *sf_get_sim_state_info_c4_HeatExchanger(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Pref\",},{M[8],M[0],T\"is_active_c4_HeatExchanger\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_HeatExchangerInstanceStruct *chartInstance;
    chartInstance = (SFc4_HeatExchangerInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",239,-1,482);
...
{
  sf_c4_HeatExchanger((SFc4_HeatExchangerInstanceStruct*) chartInstanceVar);
}
...
static void mdlSetWorkWidths_c4_HeatExchanger(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2310553807U));
  ssSetChecksum1(S,(2166151414U));
  ssSetChecksum2(S,(2239756862U));
  ssSetChecksum3(S,(3859239199U));
